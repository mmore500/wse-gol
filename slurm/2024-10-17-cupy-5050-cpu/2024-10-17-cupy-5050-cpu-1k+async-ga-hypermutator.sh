...
WSE_SKETCHES_REVISION="84527e37db632b98600755ff90ab5bde3e3273b1"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-10-17-cupy-denovo-cpu-1k/nben=${NBEN}+async-ga-hypermutator-512"
...
./pyscript/hypermutator-denovo.py
