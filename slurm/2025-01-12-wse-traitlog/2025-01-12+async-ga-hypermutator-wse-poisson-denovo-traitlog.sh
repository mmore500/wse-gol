...
WORKDIR="${HOME}/scratch/2025-01-12/async-ga-hypermutator-wse-poisson-denovo-traitlog"
...
for NUM_AVAIL_BEN_MUTS in 12 15 18 21 24; do
for config in \
    "export ASYNC_GA_NCOL_SUBGRID=0 ASYNC_GA_NROW_SUBGRID=0 NREP=6 ASYNC_GA_NCOL=750 ASYNC_GA_NROW=994" \
; do
eval "${config}"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_cappedxl_denovo_poisson_snap"
